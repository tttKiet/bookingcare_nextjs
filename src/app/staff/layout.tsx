    ...
    () => [
      {
        key: "/staff",
        label: (
          <Link className={classItemMenu} href="/staff">
            Dashboard
          </Link>
        ),
        get icon() {
      ...
      },
      {
        key: "/staff/working",
        label: (
          <Link className={classItemMenu} href="/staff/working">
            Công tác
          </Link>
        ),
        get icon() {
      ...
      },
      {
        key: "/staff/patient",
        label: (
          <Link className={classItemMenu} href="/staff/patient">
            Quản lý bệnh nhân
          </Link>
        ),
        get icon() {
      ...
      },
      {
        key: "/staff/booking",
        label: (
          <Link className={classItemMenu} href="/staff/booking">
            Quản lý lịch hẹn
          </Link>
        ),
        get icon() {
