...
export default function RootLayout({
  ...
  const items: MenuItem[] = React.useMemo(
    () => [
      ...
      {
        key: "/hospital-manager/health-facility",
        label: (
          <Link href="/hospital-manager/health-facility">Cơ sở khám bệnh</Link>
        ),
        icon: <BiCalendarStar size={20} />,
      },
      {
        key: "/hospital-manager/service",
        label: <Link href="/hospital-manager/service">Dịch vụ khám bệnh</Link>,
  ...
  if (!profile || profile?.Role?.keyType !== "hospital_manager") {
