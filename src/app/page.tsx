          ...
          <div className="border border-spacing-0 rounded-md bg-white p-3 px-6 shadow-md ">
            <div className="gap-1 items-center grid grid-cols-12">
              ...
              <p className="col-span-6 text-sm px-2">
                ...
                cung cấp dịch vụ đặt khám nhanh, lấy số thứ tự trực tuyến và tư
                vấn sức khỏe từ xa tại các Cơ sở Y tế hàng đầu Việt Nam như Bệnh
                viện Đại học Y Dược TP.HCM, Bệnh viện Chợ Rẫy và Bệnh viện Nhi
                Đồng...
              </p>
            </div>
